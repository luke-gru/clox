...
SRCS = main.c debug.c memory.c chunk.c value.c scanner.c compiler.c vm.c object.c options.c vendor/vec.c nodes.c parser.c table.c runtime.c process.c io.c repl.c debugger.c vendor/linenoise.c
TEST_SRCS = debug.c   memory.c chunk.c value.c scanner.c compiler.c vm.c object.c options.c vendor/vec.c nodes.c parser.c table.c runtime.c process.c io.c debugger.c
