...
SRCS = main.c debug.c memory.c chunk.c value.c scanner.c compiler.c vm.c object.c string.c array.c map.c options.c vendor/vec.c nodes.c parser.c table.c runtime.c process.c signal.c io.c file.c thread.c block.c rand.c time.c repl.c debugger.c regex_lib.c regex.c vendor/linenoise.c
TEST_SRCS = debug.c   memory.c chunk.c value.c scanner.c compiler.c vm.c object.c string.c array.c map.c options.c vendor/vec.c nodes.c parser.c table.c runtime.c process.c signal.c io.c file.c thread.c block.c rand.c time.c debugger.c regex_lib.c regex.c
